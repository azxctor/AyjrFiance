...
require(['jquery',
    ...
    var getDto = function(){
        ...
        var features = {"exportFileExt":"xls","startDate":startDate,"endDate":endDate,"eventName":"member.contract","parentClientEvent":"reportController.detail","commonId":id,"timeType":typeValue};
        dto.data = $.extend(param,features);
        dto.url = global.context+"/web/report/getmemberstatisticspackage";
        return dto;
    };
