 ...
 */
@Component
public class FinancierInfoConverter implements ObjectConverter<FinancierDto, FinancierInfo> {
    ...
    @Override
    public void convertFromDomain(FinancierInfo domain, FinancierDto dto) {
    ...
    @Override
    public void convertToDomain(FinancierDto dto, FinancierInfo domain) {
