...
import com.hengxin.platform.market.validator.SubscirbeAmountValidator;
...
@Constraint(validatedBy = SubscirbeAmountValidator.class)
@Documented
public @interface SubscribeAmountCheck {
