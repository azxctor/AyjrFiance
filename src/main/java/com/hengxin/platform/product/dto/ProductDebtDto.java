 ...
 * 
 */
public class ProductDebtDto implements Serializable {
    /**
	 * 
	 */
    ...
    @Digits(fraction = 2, integer = 9, message = "{product.error.assertAmount.length}", groups = { SubmitProductApply.class })
    ...
    public DynamicOption getDtype() {
        return SystemDictUtil.getDictByCategoryAndCode(EOptionCategory.DEBT_TYPE, type);
    }
