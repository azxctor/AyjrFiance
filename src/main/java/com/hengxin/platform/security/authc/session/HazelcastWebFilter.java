...
/*
* Project Name: kmfex-platform-July
* File Name: HazelcastWebFilter.java
* Class Name: HazelcastWebFilter
*
...
import static com.hengxin.platform.security.authc.session.HazelcastInstanceLoader.CLIENT_CONFIG_LOCATION;
import static com.hengxin.platform.security.authc.session.HazelcastInstanceLoader.CONFIG_LOCATION;
import static com.hengxin.platform.security.authc.session.HazelcastInstanceLoader.INSTANCE_NAME;
import static com.hengxin.platform.security.authc.session.HazelcastInstanceLoader.USE_CLIENT;
...
public class HazelcastWebFilter implements Filter {

    private static final ILogger logger = Logger.getLogger(HazelcastWebFilter.class);
    ...
    public HazelcastWebFilter() {
    }

    public HazelcastWebFilter(Properties properties) {
        this();
    ...
    private HazelcastHttpSession createNewSession(RequestWrapper requestWrapper, String existingSessionId) {
        ...
        HazelcastHttpSession hazelcastSession = new HazelcastHttpSession(HazelcastWebFilter.this, id, originalSession, deferredWrite);
    ...
    private class HazelcastHttpSession implements HttpSession {
        ...
        final HazelcastWebFilter webFilter;
        // only true if session is created first time in the cluster
        private volatile boolean clusterWideNew;


        public HazelcastHttpSession(HazelcastWebFilter webFilter, final String sessionId, HttpSession originalSession, boolean deferredWrite) {
