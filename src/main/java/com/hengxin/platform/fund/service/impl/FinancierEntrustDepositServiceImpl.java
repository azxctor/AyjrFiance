...
/**
 * Class Name: FinancierEntrustDepositServiceImpl
 * 
 * @author dcliu
 * 
 *         融资人委托保证金服务
 */
@Service
@Qualifier("financierEntrustDepositService")
public class FinancierEntrustDepositServiceImpl implements
		FinancierEntrustDepositService {

	private final static Logger LOG = LoggerFactory
			.getLogger(FinancierEntrustDepositServiceImpl.class);
